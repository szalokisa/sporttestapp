...
export default function ExercisesForm(props) {
    ...
    },
    {
        ...
        name: 'ResToExString',
        type: 'text',
        labelText: languageElementsHandler.get(`field-ResToExString`),
        initialValue: '',
        validators: [],
    },
    ]
        ...
        <div className="form-exercises">
            ...
            >
                ...
                <div className='btn-area'>
                    ...
                    <button type='button' className='btn btn-editres' onClick={props.showResGrid}>
                        {languageElementsHandler.get(`btn-editres`)}
                    </button>
